    ...
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
        ...
        <ul class="navbar-nav mb-2 mb-lg-0">
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="<?=base_url('contract_admin/browse_contract_admin')?>">Контрагент</a></li>
        ...
        <ul class="navbar-nav mb-2 mb-lg-0">
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="<?=base_url('rep_order_contract/browse_rep_order_contract')?>">По контрагентам</a></li>
                    <li><a class="dropdown-item" href="<?=base_url('rep_order_product/browse_rep_order_product')?>">По товарам</a></li>
